...
b5 = Button(win,text=4,font="Vendata 10 bold italic ",width="8",height="2",relief=RAISED,bd=5,command=fun4).grid(row = 2,column=0,sticky=W)
...
b8.grid(row = 2,column=3,sticky=W)
